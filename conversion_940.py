    ...
    def parse_edi(self):
        ...
        for seg in self.formatted_segments:
            ...
            if seg[0] == "W05":
                ...
                ship_not_after_date_tag = et.SubElement(dates_tag, 'ShipNotAfterDate')
                deliver_not_after_date_tag = et.SubElement(dates_tag, 'DeliverNotAfterDate')
            ...
            if seg[0] == "N9" and seg[1] == "VR":
                vendor_number_tag.text = seg[2]
            if seg[0] == "N9" and seg[1] == "MR":
                merchandise_type_code_tag.text = seg[2]
            if seg[0] == "N9" and seg[1] == "SO":
                customer_order_number_tag.text = seg[2]
            if seg[0] == "N9" and seg[1] == "WH":
            ...
            if seg[0] == "G62" and seg[1] == "38":
                ship_not_after_date = seg[2]
                ship_not_after_date = '-'.join([ship_not_after_date[:4], ship_not_after_date[4:6], ship_not_after_date[6:]])
                ship_not_after_date_tag.text = ship_not_after_date
            if seg[0] == "G62" and seg[1] == "37":
            ...
            if seg[0] == "G62" and seg[1] == "54":
                deliver_not_after_date = seg[2]
                deliver_not_after_date = '-'.join(
                    [deliver_not_after_date[:4], deliver_not_after_date[4:6], deliver_not_after_date[6:]])
                deliver_not_after_date_tag.text = deliver_not_after_date
            ...
            if seg[0] == "W01":
                ...
                case_upc_tag.text = seg[7]
                item_number_tag.text = seg[7]
                try:
                    buyer_item_number_tag.text = seg[16]
                except IndexError:
                    pass
            if seg[0] == "G69":
